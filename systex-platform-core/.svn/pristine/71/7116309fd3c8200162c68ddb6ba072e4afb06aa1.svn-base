 ...
 **/
public class JConnectClientException extends CommunicationException {

//    public JConnectClientException() {
//    }

	public JConnectClientException(EnumErrInputType errInputType,String value){
    	super(errInputType,value); 	
    }
	
    public JConnectClientException(String ml_idGroup_s) {
        super(ml_idGroup_s);
    }
     ...
     *@see
     **/
    public JConnectClientException(String ml_idGroup_s,List<String> interMsgList) {
...
//     *@see
//     **/
//    public JConnectClientException(UUID userPrivilege_s, String ml_idGroup_s,List<String> interMsgList) {
...
//    }
     ...
     *@see
     **/
    public JConnectClientException(String ml_idGroup_s,List<String> interMsgList,Exception ex) {
...
//     *@see
//     **/
//    public JConnectClientException(UUID userPrivilege_s, String ml_idGroup_s,List<String> interMsgList,Exception ex) {
