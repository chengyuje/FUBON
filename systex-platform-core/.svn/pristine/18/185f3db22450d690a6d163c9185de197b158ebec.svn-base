...
/**
 *此類別的功能描述：JavaBranch的RuntimeException物件，繼承RuntimeException 此程式的注意事項：
 * 
 *@author Benson Chen
 *@since 此Class 從哪個版本開始加入 (外部的version)
 *@see
 **/
public class JBranchRuntimeException extends RuntimeException {
	...
	public JBranchRuntimeException(EnumErrInputType errInputType, String value) {
		super(value);
	...
	// public JBranchRuntimeException() {
	// }

	public JBranchRuntimeException(String ml_idGroup_s) {
		super(ml_idGroup_s);
	...
	/**
	 *此類別的功能描述：建立JBranchRuntimeException物件 此程式的注意事項：傳入多國語系群組編號存入class
	 ...
	 *@see
	 **/
	public JBranchRuntimeException(String ml_idGroup_s, List<String> interMsgList) {
		super(ml_idGroup_s);
		this._ml_idGroup = ml_idGroup_s;
	...
	// /**
	// *此類別的功能描述：建立JBranchRuntimeException物件
	...
	// *@see
	// **/
	// public JBranchRuntimeException(UUID userPrivilege_s, String ml_idGroup_s,
	 ...
	 *@see
	 **/
	public JBranchRuntimeException(String ml_idGroup, List<String> interMsgList, RuntimeException rtEx) {
		super(ml_idGroup);
		this._ml_idGroup = ml_idGroup;
		this._interMsgList = interMsgList;
		this.setRunTimeException(rtEx);
		this._uuid = null;
		// try {
	...
	// **/
	// public JBranchRuntimeException(UUID userPrivilege_s, String ml_idGroup_s,
	// List<String> interMsgList, RuntimeException rtEx) {
	// this._ml_idGroup = ml_idGroup_s;
	// this._uuid = userPrivilege_s;
	// this._interMsgList = interMsgList;
	// this.setRunTimeException(rtEx);
	...
	public void setRunTimeException(RuntimeException runTimeException) {
		this._runTimeException = runTimeException;
	}
