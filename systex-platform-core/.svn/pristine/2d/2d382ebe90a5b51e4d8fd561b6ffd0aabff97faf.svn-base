 ...
 */
public class BranchPlatformVODB extends PlatFormVO {
// ------------------------------ FIELDS ------------------------------
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    BranchPlatformVODB(String branchId) throws JBranchException {
        this.branchId = branchId;
        this.varManagerUser = (VarManager) PlatformContext.getBean("branchPlatformVarManager");;
    }
