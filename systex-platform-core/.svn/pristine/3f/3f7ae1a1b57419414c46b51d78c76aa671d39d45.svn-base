...
public class AmtUtil {
		...
		public static void main(String[] args) {
			System.out.println(transferNum(new BigDecimal("101111")));
		}
	
	     public static String transferNum(BigDecimal num) {  
	    	 
	         AmtUtil t2r = new AmtUtil();  
	         
	         return t2r.cleanZero(t2r.splitNum(t2r.roundString(num.toString())));  
...
//	     }  
	     ...
	     private String cleanZero(String s) {  
	         ...
	         //當10萬時，原顯示"壹拾萬"，改為口語話的"拾萬" 20120316 modified by Angus
	         if(s.startsWith("壹拾")){
	        	 s = s.replaceFirst("壹拾", "拾");  	        	 
	         }
	         //整數金額時，於元後顯示"整" 20120316 modified by Angus
	         if(s.endsWith("元")){
	        	 s = s + "整";
	         }
	         return s;  
