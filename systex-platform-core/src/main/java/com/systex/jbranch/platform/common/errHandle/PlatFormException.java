 ...
 * @author Benson
 */
public class PlatFormException extends JBranchException {

	
	
	public PlatFormException(EnumErrInputType errInputType, String value,
			Throwable cause) {
...
//        
//    }
    public PlatFormException(String ml_idGroup_s) {
        super(ml_idGroup_s);
    }
     ...
     *@see
     **/
    public PlatFormException(String ml_idGroup_s, List<String> interMsgList) {
