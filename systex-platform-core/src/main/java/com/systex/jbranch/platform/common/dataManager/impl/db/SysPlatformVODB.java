 ...
 */
public class SysPlatformVODB extends PlatFormVO {
// ------------------------------ FIELDS ------------------------------
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    public SysPlatformVODB() throws JBranchException {
        this.varManagerUser = (SingleVarManager) PlatformContext.getBean("sysPlatformVarManager");
    }
