...
public class NJBRVA2OutputVO {
	...
	private List<NJBRVA2OutputVODetails> details;
    ...
    public List<NJBRVA2OutputVODetails> getDetails() {
        return details;
    }

    public void setDetails(List<NJBRVA2OutputVODetails> details) {
