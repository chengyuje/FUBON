...
@XmlType
public class WMS032154OutputVO {
	@XmlElement
    private String CUST_NAME_S;
	@XmlElement(name="TxRepeat")
	private List<WMS032154OutputDetailsVO> details;
	...
	public List<WMS032154OutputDetailsVO> getDetails() {
		return details;
	}
	public void setDetails(List<WMS032154OutputDetailsVO> details) {
