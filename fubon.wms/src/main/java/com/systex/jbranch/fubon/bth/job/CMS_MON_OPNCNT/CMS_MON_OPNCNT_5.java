 ...
 * 開櫃數_by時段_平日
 */
@Component("CMS_MON_OPNCNT_5")
public class CMS_MON_OPNCNT_5 implements IPrepareStatementInfo, IGenerateCsvInfo
{
	...
	public String getSQL() {
		return new StringBuffer()
			...
			.append("  select DECODE(COUNT(*)-6,0,1) CNT2 ")
			.append("  from TBCMS_PS_CMS_BUSYDAY ")
			.append("  where CNT > 1000 ")
			.append("  and YEARMONTH = TO_CHAR(ADD_MONTHS(sysdate,-1), 'YYYYMM'))), 2) AVGCNT ")
			.append("from ( ")
			...
			.append("    where UNITID <> '689' and DATADATE not in ( ")
	...
	public String getCsvFileName() {
		return AccessContext.sdf.format(new Date()) + "開櫃數_by時段_平日";
	}
