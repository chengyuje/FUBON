...
public class NR096NOutputVO {
    ...
    private List<NR096NOutputVODetails> details;
    ...
    public List<NR096NOutputVODetails> getDetails() {
        return details;
    }

    public void setDetails(List<NR096NOutputVODetails> details) {
