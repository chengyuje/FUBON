 ...
 */
@Component("CMS_MON_WAIT30S_01")
public class CMS_MON_WAIT30S_01 implements IPrepareStatementInfo, IGenerateCsvInfo
{

	@Override
	public String getSQL() {
		return new StringBuffer()
			.append("select a.YEARMONTH, SUM(a.CNT) CNT, a.WAIT30CNT ")
			.append("from ( ")
			.append("  select SUBSTRING(DATADATE,1,4)+SUBSTRING(DATADATE,6,2) YEARMONTH, DATADATE, 1 CNT,(WAITTIME/30)+1 WAIT30CNT, WAITTIME ")
			...
			.append("group by a.YEARMONTH, a.WAIT30CNT ")
			.append("order by a.WAIT30CNT ")
			.toString();
	}
	...
	public String getCsvFileName() {
		return AccessContext.sdf.format(new Date()) + "等待30秒筆數_全行";
	}

	@Override
	public String[] getCsvHeader() {
		return new String[]{"YEARMONTH", "CNT", "WAIT30CNT"};
	}
