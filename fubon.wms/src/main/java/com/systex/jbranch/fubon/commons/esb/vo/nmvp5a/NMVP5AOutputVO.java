...
public class NMVP5AOutputVO {
	...
	private List<NMVP5AOutputDetailsVO> details;
	...
	public List<NMVP5AOutputDetailsVO> getDetails() {
		return details;
	}

	public void setDetails(List<NMVP5AOutputDetailsVO> details) {
