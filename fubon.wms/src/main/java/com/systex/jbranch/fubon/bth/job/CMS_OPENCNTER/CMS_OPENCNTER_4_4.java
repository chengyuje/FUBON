 ...
 * 
 */
@Component("CMS_OPENCNTER_4_4")
public class CMS_OPENCNTER_4_4 extends CMS_OPENCNTER_4_34_SOURCE
							   implements IPrepareStatementInfo, IGenerateFileInfo
{

	@Override
	public String getJobNameCol() {
		return "'OPENCNTER                     ' Job_name";
	}
	...
	public String getFileName() {
		return "ZWMG_FA_DSK_SQI_BAK." + AccessContext.sdf.format(new Date());
	}
