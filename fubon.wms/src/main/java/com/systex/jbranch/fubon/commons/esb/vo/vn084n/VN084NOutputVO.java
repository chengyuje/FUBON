...
public class VN084NOutputVO {
	...
	private List<VN084NOutputDetailVO> details;
	...
	public List<VN084NOutputDetailVO> getDetails() {
		return details;
	}

	public void setDetails(List<VN084NOutputDetailVO> details) {
