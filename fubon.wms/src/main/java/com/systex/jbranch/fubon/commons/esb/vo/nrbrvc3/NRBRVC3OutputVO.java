...
public class NRBRVC3OutputVO {
	...
	private List<NRBRVC3OutputDetailsVO> details;
	...
	public List<NRBRVC3OutputDetailsVO> getDetails() {
		return details;
	}

	public void setDetails(List<NRBRVC3OutputDetailsVO> details) {
