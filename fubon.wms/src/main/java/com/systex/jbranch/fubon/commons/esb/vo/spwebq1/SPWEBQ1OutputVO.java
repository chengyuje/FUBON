...
public class SPWEBQ1OutputVO {
	...
	private List<SPWEBQ1OutputDetailVO> details;
	...
	public List<SPWEBQ1OutputDetailVO> getDetails() {
		return details;
	}

	public void setDetails(List<SPWEBQ1OutputDetailVO> details) {
