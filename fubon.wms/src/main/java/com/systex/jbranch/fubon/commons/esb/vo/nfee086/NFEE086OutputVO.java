...
public class NFEE086OutputVO {
    ...
    private List<NFEE086OutputVODetailsVO> details;    

    
    public List<NFEE086OutputVODetailsVO> getDetails() {
		return details;
	}

	public void setDetails(List<NFEE086OutputVODetailsVO> details) {
