 ...
 * 開櫃數_by分行by時段_平日
 */
@Component("CMS_MON_OPNCNT_2")
public class CMS_MON_OPNCNT_2 implements IPrepareStatementInfo, IGenerateCsvInfo
{
	...
	public String getSQL() {
		return new StringBuffer()
			...
			.append("      from ( ")
			.append("        select DATADATE, CNT from TBCMS_PS_CMS_BUSYDAY ")
	...
	public String getCsvFileName() {
		return AccessContext.sdf.format(new Date()) + "開櫃數_by分行by時段_平日";
	}
