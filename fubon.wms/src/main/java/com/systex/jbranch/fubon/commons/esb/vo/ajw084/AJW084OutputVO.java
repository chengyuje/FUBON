...
public class AJW084OutputVO {
	...
	private List<AJW084OutputDetailVO> details;
	...
	public List<AJW084OutputDetailVO> getDetails() {
		return details;
	}

	public void setDetails(List<AJW084OutputDetailVO> details) {
