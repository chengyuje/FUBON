package com.systex.jbranch.fubon.commons.esb.vo.tp032675;
...
public class TP032675OutputVO {
	...
	private List<TP032675OutputDetailsVO> details;
	...
	public List<TP032675OutputDetailsVO> getDetails() {
		return details;
	}

	public List<TP032675OutputDetailsVO> setDetails( List<TP032675OutputDetailsVO> details) {
