...
public class MPlusEmpolyeeUtilTest extends AbstractMPlus {
	private Logger logger = LoggerFactory.getLogger(this.getClass());
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private final Map<Class , String> urlMapping = new Hashtable();
	
	public MPlusEmpolyeeUtilTest() {
	...
	public static void main(String...args){
		...
		new MPlusEmpolyeeUtilTest().send2MPlusForPost(vo , new MPlusCheckUtils());
	}
...
//        	inputVO.setPassword(config.get("password"));//密碼
//        	inputVO.setSecretKey(config.get("SecretKey"));
        	inputVO.setAccount("pmtest0935");//帳號
        	inputVO.setPassword("Zqb05ci7OD3SszFxP68f99GqKwtcreVSK2rqZlm24/M=");//密碼
        	inputVO.setSecretKey("d9b654287f4fc7a6");
