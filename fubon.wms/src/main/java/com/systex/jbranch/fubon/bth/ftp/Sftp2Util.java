...
/**
 * Created by Jemmy Tsai on 2017/12/27
 *
 * SFTP實作FtpUtilInf內容, for sha2
 */
public class Sftp2Util implements FtpUtilInf {
	private TBSYSREMOTEHOSTVO hostVO;
	private Logger logger = LoggerFactory.getLogger(Sftp2Util.class);

	public Sftp2Util(TBSYSREMOTEHOSTVO hostVO) {
		this.hostVO = hostVO;
//		JSch.setConfig("kex", "diffie-hellman-group1-sha1");
	...
	public static void main(String[] args) throws Exception {
		...
		Sftp2Util myftpUtil = new Sftp2Util(vo);
		try {
