...
public class SOT320InputVO extends PagingInputVO {
...
//	private String stockCode;
	...
	private String gtcYN;				//當日單N 長效單Y
	private Date gtcStartDate;			//長效單起日
	private Date gtcEndDate;			//長效單迄日
	private BigDecimal gtcRefVal;		//長效單委託價格
	...
	public String getGtcYN() {
		return gtcYN;
	}

	public void setGtcYN(String gtcYN) {
		this.gtcYN = gtcYN;
	}

	public Date getGtcStartDate() {
		return gtcStartDate;
	}
	public void setGtcStartDate(Date gtcStartDate) {
		this.gtcStartDate = gtcStartDate;
	}
	public Date getGtcEndDate() {
		return gtcEndDate;
	}

	public void setGtcEndDate(Date gtcEndDate) {
		this.gtcEndDate = gtcEndDate;
	}

	public BigDecimal getGtcRefVal() {
		return gtcRefVal;
	}

	public void setGtcRefVal(BigDecimal gtcRefVal) {
		this.gtcRefVal = gtcRefVal;
	}
