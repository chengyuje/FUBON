...
import com.systex.jbranch.app.server.fps.crm235.CRM235OutputVO;
import com.systex.jbranch.app.server.fps.crm235.CRM235;
...
@Component("crm235")
@Scope("request")
public class CRM235 extends FubonWmsBizLogic{
	
	private DataAccessManager dam = null;
	private Logger logger = LoggerFactory.getLogger(CRM235.class);
	
	
	/*海外債-商品代號*/
	public void getBondnbr(Object body, IPrimitiveMap header) throws JBranchException {
		CRM235OutputVO return_VO = new CRM235OutputVO();
		dam = this.getDataAccessManager();
		
		QueryConditionIF queryCondition = dam.getQueryCondition(DataAccessManager.QUERY_LANGUAGE_TYPE_VAR_SQL);
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT DISTINCT PRD_ID FROM TBPRD_BOND ORDER BY PRD_ID ");
	...
	public void getProdname(Object body, IPrimitiveMap header) throws JBranchException {
		...
		QueryConditionIF queryCondition = dam.getQueryCondition(DataAccessManager.QUERY_LANGUAGE_TYPE_VAR_SQL);
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT DISTINCT BOND_CNAME_A FROM TBPRD_BOND ORDER BY BOND_CNAME_A ");
		queryCondition.setQueryString(sql.toString());
		// result
		List<Map<String, Object>> list = dam.exeQuery(queryCondition);
		return_VO.setResultList(list);
	...
	/*海外債-取得發行機構名稱*/	
	public void getInstition(Object body, IPrimitiveMap header) throws JBranchException {
		CRM235OutputVO return_VO = new CRM235OutputVO();
		dam = this.getDataAccessManager();
		
		QueryConditionIF queryCondition = dam.getQueryCondition(DataAccessManager.QUERY_LANGUAGE_TYPE_VAR_SQL);
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT DISTINCT INSTITION_OF_FLOTATION FROM TBPRD_BONDINFO ");
		queryCondition.setQueryString(sql.toString());
		// result
		List<Map<String, Object>> list = dam.exeQuery(queryCondition);
		return_VO.setResultList(list);
	...
	public void inquire(Object body, IPrimitiveMap header) throws JBranchException {
		...
		CRM235InputVO inputVO = (CRM235InputVO) body;
		
		CRM230_ALLInputVO inputVO_all = new CRM230_ALLInputVO();
		inputVO_all.setCrm235inputVO(inputVO);
		...
		outputVO_crm230 = crm230.inquire_common(inputVO_all, "CRM235");
...
//				+ " A.AO_CODE, A.GENDER, A.BIRTH_DATE, B.CO_ACCT_YN, "
//				+ " A.BRA_NBR, C.CERT_NBR, C.BOND_NBR,C.PROD_NAME, C.VALU_CRCY_TYPE,C.DENO_AMT   " 
...
//				
////				if (inputVO.getBondcateid() != null)
////					sql.append("and BONDCATEID= :bondcateid ");
////				if (inputVO.getDateofmaturity() != null)
////					sql.append("and DATEOFMATURITY= :dateofmaturity ");
////				if (inputVO.getProd_risk_level() != null)
////					sql.append("and PROD_RISK_LEVEL = :prod_risk_level ");
////				if(inputVO.getIsnstitionoftation() != null)
////					sql.append("and ISNSTITIONOFTATION = :isnstitionoftation ");
//								
//				queryCondition.setQueryString(sql.toString());
//				
//				// where 2
...
////				if(inputVO.getBondcateid() != null)
////					queryCondition.setObject("bondcateid", inputVO.getBondcateid());
////				if(inputVO.getDateofmaturity() != null)
////					queryCondition.setObject("dateofmaturity", inputVO.getDateofmaturity());
////				if(inputVO.getProd_risk_level()!= null)
////					queryCondition.setObject("prod_risk_level", inputVO.getProd_risk_level());
////				if(inputVO.getIsnstitionoftation()!= null)
////					queryCondition.setObject("isnstitionoftation", inputVO.getIsnstitionoftation());
//				//頁數
