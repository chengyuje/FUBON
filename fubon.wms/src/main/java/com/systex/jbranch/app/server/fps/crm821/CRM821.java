...
public class CRM821 extends EsbUtil {
	...
	public void getNFVIPA(Object body, IPrimitiveMap header) throws Exception {
		...
		List<Map<String, Object>> redeemFunList = new ArrayList();
		getCustAssetNFData(cust_id, AssetFunList, redeemFunList, "NF");
		if(StringUtils.equals("Y", isOBU)){
			getCustAssetNFData(cust_id, AssetFunList, redeemFunList, "AF");
		}
		...
		return_VO.setResultList(D1List); //庫存資料
		return_VO.setRedeemList(redeemFunList); //贖回在途資料
...
//		List<Map<String, Object>> resultList = new ArrayList<Map<String, Object>>();
     ...
     * @author SamTu
     */
	public void getCustAssetNFData(String cust_id, List<CustAssetFundVO> total, List<Map<String, Object>> redeemList, String mark) throws Exception {
        ...
        //處理資料
		dealAF_NF_Data(vos,total,redeemList,mark);
	}
	
	private void dealAF_NF_Data(List<ESBUtilOutputVO> vos, List<CustAssetFundVO> total, List<Map<String, Object>> redeemList, String mark) throws Exception {
		Boolean isAF = StringUtils.equals("AF", mark);
...
//                	if(checkCustAssetFundVO(devo)){
            ...
            } else if("1003".equals(hfmtid)) { //贖回在途資料
            	NFBRN9OutputVO outputVO;
            	if (isAF) {
            		outputVO = esbUtilOutputVO.getAfbrn9OutputVO();
             	} else {
            	...
            	for (NFBRN9OutputVODetailsVO devo : outputVO.getDetails()) {
            		...
            		Date effDate = null;
            		if (devo.getEffDate() != null && !"0000000".equals(devo.getEffDate())) {
            		...
            		if (devo.getPostingDate() != null && !"00000000".equals(devo.getPostingDate())) {
            			// 『本行預計入帳日』若已過期則排除
