...
@Component("crm845")
@Scope("request")
public class CRM845 extends FubonWmsBizLogic {
	...
	public void inquire(Object body, IPrimitiveMap header) throws Exception {
		...
		CRM845OutputVO outputVO = new CRM845OutputVO();
		CRM845InputVO inputVO = (CRM845InputVO) body;
		dam = this.getDataAccessManager();	
		QueryConditionIF queryCondition = dam.getQueryCondition(DataAccessManager.QUERY_LANGUAGE_TYPE_VAR_SQL);		
		StringBuffer sb = new StringBuffer();	
		
		//發送電文
		List<SC120100OutputVO> vos = sc120100Service.searchStudentForeignLoan(inputVO.getCust_id().trim());
