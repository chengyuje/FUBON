...
public class SOT413OutputVO extends PagingOutputVO {
	// 客戶
	...
	private BigDecimal purchaseAmtTwd; //申購金額折台
	...
	public BigDecimal getPurchaseAmtTwd() {
		return purchaseAmtTwd;
	}

	public void setPurchaseAmtTwd(BigDecimal purchaseAmtTwd) {
		this.purchaseAmtTwd = purchaseAmtTwd;
	}
