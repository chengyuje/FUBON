 ...
 * KYC自然人空白差異表問卷
 */
@Component("kyc310PersonRptEmptyComp")
@Scope("prototype")
public class KYC310_PersonRptEmptyComp extends FubonWmsBizLogic {
    /**
     * KYC 相關資料
     **/
    ...
    private PdfPTable buildLogo() throws Exception {
        PdfPTable table = buildTable(new int[]{28, 56});
        table.addCell(logo());
    ...
    private PdfPTable buildPart2Preface() throws Exception {
        ...
        table.addCell(buildCell("\n本人茲聲明已充份瞭解本問卷的問題及選項內容，且本問卷填答內容已正確及真實地反應本人現時狀況及投資目標。", bFont, Paragraph.ALIGN_LEFT, 20, 0));
//        table.addCell(buildBlankCell(18, 0));
