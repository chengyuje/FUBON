...
public class SOT420OutputVO extends PagingOutputVO {
	...
	private List<Map<String, Object>> prodAcct;//組合式商品帳號
	private List<Map<String, Object>> debitAcct;  //贖回入帳帳號
	...
	public List<Map<String, Object>> getProdAcct() {
		return prodAcct;
	}

	public void setProdAcct(List<Map<String, Object>> prodAcct) {
