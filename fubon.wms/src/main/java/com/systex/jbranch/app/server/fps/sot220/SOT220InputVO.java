...
public class SOT220InputVO extends PagingInputVO {
	...
	public void setIsNewProd(String isNewProd) {
		this.isNewProd = isNewProd;
	}

	public BigDecimal getUnitNum1() {
		return unitNum1;
	}

	public void setUnitNum1(BigDecimal unitNum1) {
		this.unitNum1 = unitNum1;
	}
