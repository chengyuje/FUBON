...
public class SOT220OutputVO extends PagingOutputVO {
	...
	//0695
	private List<Map<String, Object>> includingDigitdebitAcct;
	...
	public List<Map<String, Object>> getIncludingDigitdebitAcct() {
		return includingDigitdebitAcct;
	}

	public void setIncludingDigitdebitAcct(List<Map<String, Object>> includingDigitdebitAcct) {
		this.includingDigitdebitAcct = includingDigitdebitAcct;
	}
