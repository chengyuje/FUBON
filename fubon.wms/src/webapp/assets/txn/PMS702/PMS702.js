 ...
 */
'use strict';
eSoafApp.controller('PMS702Controller',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) 
	{
		$controller('BaseController', {$scope: $scope});
		$controller('PMSRegionController', {$scope: $scope});
		$scope.controllerName = "PMS702Controller";	
		$scope.init = function()
		{
			$scope.inputVO = {
	 ...
	 $scope.isq = function()
	 {
    	...
    	$scope.exportRPT = function()
    	{
			...
			$scope.sendRecv("PMS702", "export",	"com.systex.jbranch.app.server.fps.pms702.PMS702InputVO",$scope.inputVO,
		...
		$scope.inquire = function()
		{
			...
			$scope.sendRecv("PMS702", "inquire", "com.systex.jbranch.app.server.fps.pms702.PMS702InputVO", $scope.inputVO,
					function(tota, isError) 
					{
						if (!isError) 
						{
