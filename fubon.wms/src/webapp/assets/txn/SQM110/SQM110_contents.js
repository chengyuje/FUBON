 ...
 */
'use strict';
eSoafApp.controller('SQM110_contentsController', function($rootScope, $scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter, getParameter) {
	$controller('BaseController', {$scope : $scope});
	$scope.controllerName = "SQM110_contentsController";
//	$controller('PMSRegionController', {$scope: $scope});
	...
	if('WMS05' != $scope.inputVO.qtnType){
		...
		$scope.sendRecv("SQM110", "getQuestion", "com.systex.jbranch.app.server.fps.sqm110.SQM110DetailInputVO", {'qtnType':$scope.row.QTN_TYPE, 'data_date':$scope.row.DATA_DATE , 'cust_id':$scope.row.CUST_ID},
