'use strict';
eSoafApp.controller('PMS418UController', function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter, sysInfoService) {
	...
	$scope.initPMS418U = function() {
		...
		$scope.sendRecv("PMS401U", "isMainten", "com.systex.jbranch.app.server.fps.pms401u.PMS401UInputVO", {'itemID': 'PMS418U'}, function(tota, isError) {
			if (!isError) {
