 ...
 */
'use strict';
eSoafApp.controller('PRD241_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD241_UPLOADController";
		
		$scope.inputVO = {};
		
		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD241", "downloadSimple", "com.systex.jbranch.app.server.fps.prd241.PRD241InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD241", "upload", "com.systex.jbranch.app.server.fps.prd241.PRD241InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
