	...
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, $timeout, $filter) {
	  ...
	  //import xls
		$scope.importfile = function() { 
			...
			$scope.sendRecv("PMS213", "addBenAdj","com.systex.jbranch.app.server.fps.pms213.PMS213UpdateInputVO",
	 ...
	 //調用存儲過程存excel表
	   $scope.callStored = function() {
			$scope.sendRecv("PMS213", "callStored", "com.systex.jbranch.app.server.fps.pms213.PMS213UpdateInputVO", $scope.inputVO,
