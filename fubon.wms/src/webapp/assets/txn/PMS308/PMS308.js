 ...
 */
'use strict';
eSoafApp.controller('PMS308Controller',
    function ($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
        $controller('BaseController', {$scope: $scope});
        $scope.controllerName = "PMS308Controller";
        // 繼承共用的組織連動選單
...
//            $scope.RegionController_getORG($scope.inputVO);
        ...
        //var date = new Date(2019, 0, 2, 0, 0, 0);
        var date    = new Date();
...
//            $scope.bgn_sDateOptions.minDate = monthFirstDate;
        ...
        $scope.query = function () {
            ...
            $scope.sendRecv("PMS308", "queryData", "com.systex.jbranch.app.server.fps.pms308.PMS308InputVO", $scope.inputVO,
...
//			$scope.sendRecv("PMS308", "export", "com.systex.jbranch.app.server.fps.pms308.PMS308IputVO", $scope.iutputVO,
//					function(tota, isError) {						
//						if (isError) {
...
//		};
        ...
        $scope.exportRPT = function () {
            $scope.sendRecv("PMS308", "export", "com.systex.jbranch.app.server.fps.pms308.PMS308OutputVO", $scope.outputVO,
                function (tota, isError) {
                    if (!isError) {
                        return;
                    }
