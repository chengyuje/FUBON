 ...
 */
'use strict';
eSoafApp.controller('IOT170_REPORT_DETAILController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "IOT170_REPORT_DETAILController";
		...
		$scope.query = function(){			
			$scope.sendRecv("IOT170", "getReportDetail", "com.systex.jbranch.app.server.fps.iot170.IOT170InputVO", $scope.inputVO,
