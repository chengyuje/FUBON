'use strict';
eSoafApp.controller('CRM997_POTENTIAL_UPLOADController',function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
    $controller('BaseController', {$scope: $scope});
    $scope.controllerName = "CRM997_POTENTIAL_UPLOADController";
    
    $scope.inputVO.setting_type = '1';
