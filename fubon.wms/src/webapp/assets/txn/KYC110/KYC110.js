...
//        	$scope.edit=[{LABEL:'修改',DATA:'U'},{LABEL:'刪除',DATA:'D'}];
        ...
        $scope.queryData = function(){
        	$scope.sendRecv("KYC110","queryData","com.systex.jbranch.app.server.fps.kyc110.KYC110InputVO",
...
//								row.PICTURE='N';
        ...
        $scope.delQuestion = function(QUESTION_VERSION){
        	...
        	$confirm({text: '是否刪除此筆資料!!'},{size: 'sm'}).then(function(){
               	$scope.sendRecv("KYC110","delete","com.systex.jbranch.app.server.fps.kyc110.KYC110InputVO",
            			$scope.inputVO,function(tota,isError){
            			if(isError){
        ...
        $scope.btnToUpdate = function(row,list){
        	var dialog = ngDialog.open({
        		template: 'assets/txn/KYC111/KYC111.html',
        		className: 'KYC111',
