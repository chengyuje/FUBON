...
//			alert(JSON.stringify($scope.inputVO));
			$scope.sendRecv("MPL110", "getAum", "com.systex.jbranch.app.server.fps.mpl110.MPL110InputVO", $scope.inputVO,
