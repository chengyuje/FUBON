	...
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, $timeout, $filter) {
	  ...
	  //import xls
		$scope.importfile = function() {
			...
			$scope.sendRecv("PMS708", "addData", "com.systex.jbranch.app.server.fps.pms708.PMS708InputVO", $scope.inputVO,
	  ...
	  //調用存儲過程存excel表
	   $scope.callStored = function() {
			$scope.sendRecv("PMS708", "callStored", "com.systex.jbranch.app.server.fps.pms708.PMS708InputVO", $scope.inputVO,
					function(tota, isError) {
