 ...
 */
'use strict';
eSoafApp.controller('CRM827Controller',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, getParameter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "CRM827Controller";
...
//			$scope.inputVO.cust_id = $scope.connector('get','CRM110_CUST_ID');
		...
		$scope.sendRecv("CRM827", "inquire", "com.systex.jbranch.app.server.fps.crm827.CRM827InputVO", $scope.inputVO,
...
//							$scope.showMsg("ehl_01_common_009");
		...
		$scope.detail = function (row) {
			var dialog = ngDialog.open({
				template: 'assets/txn/CRM827/CRM827_DETAIL.html',
				className: 'CRM827_DETAIL',
				showClose: false,
