 ...
 */
'use strict';
eSoafApp.controller('PMS226_DETAILController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, $timeout, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS226_DETAILController";
		$scope.init = function(){
			$scope.inputVO.sTime = $scope.sTime;
			$scope.inputVO.custId = $scope.custId;
	    	$scope.sendRecv("PMS226", "detail", "com.systex.jbranch.app.server.fps.pms226.PMS226InputVO", $scope.inputVO,
