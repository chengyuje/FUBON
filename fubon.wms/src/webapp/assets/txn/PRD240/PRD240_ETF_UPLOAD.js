 ...
 */
'use strict';
eSoafApp.controller('PRD240_ETF_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD240_ETF_UPLOADController";

		$scope.inputVO = {};

		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD240", "etf_downloadSimple", "com.systex.jbranch.app.server.fps.prd240.PRD240InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD240", "etf_upload", "com.systex.jbranch.app.server.fps.prd240.PRD240InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
