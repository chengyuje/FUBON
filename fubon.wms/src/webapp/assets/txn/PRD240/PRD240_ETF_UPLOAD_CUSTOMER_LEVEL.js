 ...
 */
'use strict';
eSoafApp.controller('PRD240_ETF_UPLOAD_CUSTOMER_LEVELController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD240_ETF_UPLOAD_CUSTOMER_LEVELController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD240", "uploadCustomerLevel", "com.systex.jbranch.app.server.fps.prd240.PRD240InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
