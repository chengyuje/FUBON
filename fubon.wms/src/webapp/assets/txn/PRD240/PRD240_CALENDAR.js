 ...
 */
'use strict';
eSoafApp.controller('PRD240_CALENDARController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD240_CALENDARController";
		
		$scope.uploadINV = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD240/PRD240_INV_UPLOAD.html',
		...
		$scope.uploadREST = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD240/PRD240_REST_UPLOAD.html',
				className: 'PRD240_REST_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
		...
		$scope.uploadDIVIDEND = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD240/PRD240_DIVIDEND_UPLOAD.html',
				className: 'PRD240_DIVIDEND_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
		...
		$scope.uploadMATURITY = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD240/PRD240_MATURITY_UPLOAD.html',
				className: 'PRD240_MATURITY_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
