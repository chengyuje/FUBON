 ...
 */
'use strict';
eSoafApp.controller('PRD240_UPLOADController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, getParameter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD240_UPLOADController";
		...
		$scope.inquire = function() {
			...
			$scope.sendRecv("PRD240", "upload_inquire", "com.systex.jbranch.app.server.fps.prd240.PRD240InputVO", $scope.inputVO,
