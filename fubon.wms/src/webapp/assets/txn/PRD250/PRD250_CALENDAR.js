 ...
 */
'use strict';
eSoafApp.controller('PRD250_CALENDARController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD250_CALENDARController";
		
		
		
		$scope.uploadINV = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD250/PRD250_INV_UPLOAD.html',
				className: 'PRD250_INV_UPLOAD',
				showClose: false,
		...
		$scope.uploadREST = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD250/PRD250_REST_UPLOAD.html',
				className: 'PRD250_REST_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
		...
		$scope.uploadDIVIDEND = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD250/PRD250_DIVIDEND_UPLOAD.html',
				className: 'PRD250_DIVIDEND_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
		...
		$scope.uploadMATURITY = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD250/PRD250_MATURITY_UPLOAD.html',
				className: 'PRD250_MATURITY_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
