 ...
 */
'use strict';
eSoafApp.controller('PRD250_BOND_UPLOAD_PROJECTController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD250_BOND_UPLOAD_PROJECTController";

		$scope.inputVO = {};

		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD230", "downloadProjectSimple", "com.systex.jbranch.app.server.fps.prd230.PRD230InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD250", "uploadProject", "com.systex.jbranch.app.server.fps.prd250.PRD250InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
