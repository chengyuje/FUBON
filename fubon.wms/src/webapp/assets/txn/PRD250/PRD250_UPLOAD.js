 ...
 */
'use strict';
eSoafApp.controller('PRD250_UPLOADController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, getParameter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD250_UPLOADController";
		...
		$scope.inquire = function() {
			...
			$scope.sendRecv("PRD250", "upload_inquire", "com.systex.jbranch.app.server.fps.prd250.PRD250InputVO", $scope.inputVO,
