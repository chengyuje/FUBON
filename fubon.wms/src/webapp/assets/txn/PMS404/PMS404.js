 ...
 */
'use strict';
eSoafApp.controller('PMS404Controller', function($scope, $controller,
		socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
	$controller('BaseController', {
		$scope : $scope
	});
	$scope.controllerName = "PMS404Controller";
   ...
   //營運區資訊
	...
	$scope.query = function() {
		$scope.sendRecv("PMS404", "queryData",
				"com.systex.jbranch.app.server.fps.pms404.PMS404InputVO",
	...
	$scope.export = function() {
		$scope.sendRecv("PMS404", "export",
				"com.systex.jbranch.app.server.fps.pms404.PMS404OutputVO",
