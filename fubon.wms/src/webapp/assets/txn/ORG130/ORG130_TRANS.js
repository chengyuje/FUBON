 ...
 */
'use strict';
eSoafApp.controller('ORG130_TRANSController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "ORG130_TRANSController";
			...
			$scope.sendRecv("ORG130", "rewcust", "com.systex.jbranch.app.server.fps.org130.ORG130InputVO", $scope.inputVO,
					function(tota, isError) {
						...
						if(tota[0].body.rewcust[0].REWCUST == "1"){
							...
							$scope.sendRecv("ORG130", "transrmk", "com.systex.jbranch.app.server.fps.org130.ORG130InputVO",$scope.inputVO,
									function(tota, isError) {
									if(!isError){
										if (isError) {
											$scope.showErrorMsg(tota[0].body.msgData);
		...
		$scope.genRegion = function() {
			$scope.sendRecv("ORG130", "region", "com.systex.jbranch.app.server.fps.org130.ORG130InputVO",{},
					function(tota, isError) {
						if(!isError){  
		...
		$scope.regionChange = function() {
			...
			$scope.sendRecv("ORG130", "op", "com.systex.jbranch.app.server.fps.org130.ORG130InputVO",{},
					function(tota, isError) {
						if(!isError){  
		...
		$scope.areaChange = function() {
			...
			$scope.sendRecv("ORG130", "branch", "com.systex.jbranch.app.server.fps.org130.ORG130InputVO",{},
					function(tota, isError) {
						if(!isError){  
