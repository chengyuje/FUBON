 ...
 */
'use strict';
eSoafApp.controller('PMS106_NEWINS_DETAILController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS106_NEWINS_DETAILController";
		...
		$scope.queryNE = function(){
			...
			$scope.sendRecv("PMS106", "queryNEWINS", "com.systex.jbranch.app.server.fps.pms106.PMS106InputVO", $scope.inputVO,
