 ...
 */
'use strict';
eSoafApp.controller('PMS357_EDITController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS357_EDITController";
        ...
        $scope.exl_file =function(set_name){
        	$scope.inputVO.set_code = "PMS357";
	    	$scope.exceil_delete = function() {
	    		$scope.sendRecv("PMS357", "tuncateTable", "com.systex.jbranch.app.server.fps.pms357.PMS357InputVO", $scope.inputVO,
