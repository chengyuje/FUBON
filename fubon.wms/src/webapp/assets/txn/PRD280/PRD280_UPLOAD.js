 ...
 */
'use strict';
eSoafApp.controller('PRD280_UPLOADController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, getParameter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD280_UPLOADController";
		...
		$scope.inquire = function() {
			...
			$scope.sendRecv("PRD280", "upload_inquire", "com.systex.jbranch.app.server.fps.prd280.PRD280InputVO", $scope.inputVO,
