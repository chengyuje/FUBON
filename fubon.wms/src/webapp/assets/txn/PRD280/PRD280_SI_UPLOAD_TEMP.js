'use strict';
eSoafApp.controller('PRD280_SI_UPLOAD_TEMPController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD280_SI_UPLOAD_TEMPController";
		
		$scope.inputVO = {};
		
		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD280", "downloadSimpleTemp", "com.systex.jbranch.app.server.fps.prd280.PRD280InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD280", "uploadTemp", "com.systex.jbranch.app.server.fps.prd280.PRD280InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
