 ...
 */
'use strict';
eSoafApp.controller('PMS711_ps11Controller',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS711_ps11Controller";
		$scope.select = function() {
			...
			$scope.sendRecv("PMS711","queryPs11","com.systex.jbranch.app.server.fps.pms711.PMS711InputVO",$scope.inputVO,
		...
		/*$scope.update = function() {
			...
			$scope.sendRecv("PMS711","savePs11","com.systex.jbranch.app.server.fps.pms711.PMS711InputVO",$scope.inputVO,
				function(tota, isError) {
					if (!isError) {
