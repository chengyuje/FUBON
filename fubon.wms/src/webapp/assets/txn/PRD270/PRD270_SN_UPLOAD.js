 ...
 */
'use strict';
eSoafApp.controller('PRD270_SN_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD270_SN_UPLOADController";

		$scope.inputVO = {};

		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD270", "downloadSimple", "com.systex.jbranch.app.server.fps.prd270.PRD270InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD270", "upload", "com.systex.jbranch.app.server.fps.prd270.PRD270InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
