 ...
 */
'use strict';
eSoafApp.controller('PRD270_MATURITY_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD270_MATURITY_UPLOADController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD280", "uploadMATURITY", "com.systex.jbranch.app.server.fps.prd280.PRD280InputVO", $scope.inputVO,
