 ...
 */
'use strict';
eSoafApp.controller('PRD270_SN_UPLOAD_PROJECTController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD270_SN_UPLOAD_PROJECTController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD270", "uploadProject", "com.systex.jbranch.app.server.fps.prd270.PRD270InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
