...
'use strict';
eSoafApp.controller('PMS329UController', function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService,sysInfoService,$filter,$timeout) {
	...
	$scope.controllerName = "PMS329UController";
	...
	$scope.initPMS_U = function() {
		...
		$scope.sendRecv("PMS401U", "isMainten", "com.systex.jbranch.app.server.fps.pms401u.PMS401UInputVO", {'itemID': 'PMS329U'},function(tota, isError) {
			if (!isError) {
