 ...
 */
'use strict';
eSoafApp.controller('PRD230_Fund_UPLOAD_PROJECTController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD230_Fund_UPLOAD_PROJECTController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD230", "uploadProject", "com.systex.jbranch.app.server.fps.prd230.PRD230InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
