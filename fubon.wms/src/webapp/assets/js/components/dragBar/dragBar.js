...
eSoafApp.component('dragBar', {
  ...
  templateUrl: 'assets/js/components/dragBar/dragBar.html',
  controller: ['$document', '$element', function ($document, $element) {
    ...
    ctrl.$postLink = function () {
      if (ctrl.draggable) {
        ...
        var startX = bar[0].offsetLeft+($(window).width()*50)/100 - parseFloat(barStyle['margin-left']);
        var x = 0;
        ...
        var mousemove = function mousemove(e) {
          ...
          if (ctrl.btnOnDrag && typeof ctrl.btnOnDrag === 'function'){
        	  ...
        	  console.log(tmpPct);
        	  debugger
        	  console.log(barRect.width);
        	  console.log(barRect.width);
        	  console.log(barRect.x);
        	  console.log($(window).width()*49.5);
          }
        };
