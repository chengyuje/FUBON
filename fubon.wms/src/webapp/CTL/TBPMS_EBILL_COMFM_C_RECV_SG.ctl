...
--**************************************************************************
--SOURCE> WMS_EBILL_COMFM_C_RECV.TXT
--TARGET> TBPMS_EBILL_COMFM_C_RECV_SG
...
LOAD DATA
TRUNCATE
into table TBPMS_EBILL_COMFM_C_RECV_SG
...
(   CUST_ID       	 POSITION(1:11)         --Length:11	客戶ID
  ...
  , VERSION          "0"
  , CREATOR          CONSTANT "TBPMS_EBILL_COMFM_C_RECV_SG"
  , CREATETIME       SYSDATE
  , MODIFIER         CONSTANT "TBPMS_EBILL_COMFM_C_RECV_SG"
  , LASTUPDATE       SYSDATE  )