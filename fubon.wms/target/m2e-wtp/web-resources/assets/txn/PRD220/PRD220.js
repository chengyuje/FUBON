 ...
 */
'use strict';
eSoafApp.controller('PRD220Controller',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD220Controller";
		...
		$scope.inquire = function() {
			...
			$scope.sendRecv("PRD220", "inquire", "com.systex.jbranch.app.server.fps.prd220.PRD220InputVO", $scope.inputVO,
