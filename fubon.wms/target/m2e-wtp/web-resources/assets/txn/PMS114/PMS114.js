 ...
 */
'use strict';
eSoafApp.controller('PMS114Controller', function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) {
	$controller('BaseController', {$scope: $scope});
	$scope.controllerName = "PMS114Controller";
	...
	$scope.query = function(type) {
		...
		$scope.sendRecv("PMS114", "getList", "com.systex.jbranch.app.server.fps.pms114.PMS114InputVO", $scope.inputVO, function(tota, isError) {
			if (isError) {
				$scope.showErrorMsgInDialog(tota.body.msgData);
				return;
			}
	...
	$scope.export = function(type) {
		$scope.inputVO.rep_qryList = $scope.qryList;

		$scope.sendRecv("PMS114", "export", "com.systex.jbranch.app.server.fps.pms114.PMS114InputVO", $scope.inputVO,
