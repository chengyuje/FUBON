...
eSoafApp.controller('MAO211Controller', function ($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, getParameter, $filter, $q, sysInfoService) {
    ...
    $scope.inquire = function () {
    	$scope.sendRecv("MAO211", "inquire", "com.systex.jbranch.app.server.fps.mao211.MAO211InputVO", $scope.inputVO,
	        function (tota, isError) {
	    		if (!isError) {
    ...
    $scope.add_page = function () {
      $scope.sendRecv("MAO211", "add_query", "com.systex.jbranch.app.server.fps.mao211.MAO211InputVO", $scope.inputVO,
        function (tota, isError) {
          if (!isError) {
    ...
    $scope.applicationMethod = function () {
      $scope.sendRecv("MAO211", "application", "com.systex.jbranch.app.server.fps.mao211.MAO211InputVO", $scope.inputVO,
