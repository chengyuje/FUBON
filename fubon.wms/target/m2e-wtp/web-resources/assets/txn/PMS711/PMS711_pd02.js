'use strict';
eSoafApp.controller('PMS711_pd02Controller', function($rootScope, $scope,
		$controller, $confirm, socketService, ngDialog, projInfoService) {
	$controller('BaseController', {
		$scope : $scope
	});
	$scope.controllerName = "PMS711_pd02Controller";
	//初始化
	$scope.init = function(){
		$scope.inputVO = {
				date_year  : '',
	...
	$scope.query = function() {
		...
		$scope.sendRecv("PMS711", "queryPd02","com.systex.jbranch.app.server.fps.pms711.PMS711InputVO",
	...
	$scope.save = function() {
		...
		$scope.sendRecv("PMS711", "savePd02","com.systex.jbranch.app.server.fps.pms711.PMS711InputVO",
			$scope.inputVO, function(tota, isError) {
				if (!isError) {
