 ...
 */
'use strict';
eSoafApp.controller('PRD280_DIVIDEND_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD280_DIVIDEND_UPLOADController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD280", "uploadDIVIDEND", "com.systex.jbranch.app.server.fps.prd280.PRD280InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (!isError) {
		            		...
		            		if(tota[0].body.errorList3 && tota[0].body.errorList3.length > 0)
		            			$scope.showErrorMsg('ehl_01_prd210_002',[tota[0].body.errorList3.toString()]);
