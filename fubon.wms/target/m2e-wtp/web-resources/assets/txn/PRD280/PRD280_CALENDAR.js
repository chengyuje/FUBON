 ...
 */
'use strict';
eSoafApp.controller('PRD280_CALENDARController',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD280_CALENDARController";
		
		$scope.uploadINV = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD280/PRD280_INV_UPLOAD.html',
				className: 'PRD280_INV_UPLOAD',
				showClose: false,
		...
		$scope.uploadREST = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD280/PRD280_REST_UPLOAD.html',
				className: 'PRD280_REST_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
		...
		$scope.uploadDIVIDEND = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD280/PRD280_DIVIDEND_UPLOAD.html',
				className: 'PRD280_DIVIDEND_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
		...
		$scope.uploadMATURITY = function() {
			var dialog = ngDialog.open({
				template: 'assets/txn/PRD280/PRD280_MATURITY_UPLOAD.html',
				className: 'PRD280_MATURITY_UPLOAD',
				showClose: false,
                controller: ['$scope', function($scope) {
