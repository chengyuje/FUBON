 ...
 */
'use strict';
eSoafApp.controller('PMS106_ACUMINS_DETAILController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS106_ACUMINS_DETAILController";
		...
		$scope.queryAC = function(){
			...
			$scope.sendRecv("PMS106", "queryACUMINS", "com.systex.jbranch.app.server.fps.pms106.PMS106InputVO", $scope.inputVO,
