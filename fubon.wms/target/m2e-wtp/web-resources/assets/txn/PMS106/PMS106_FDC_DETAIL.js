 ...
 */
'use strict';
eSoafApp.controller('PMS106_FCD_DETAILController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS106_FCD_DETAILController";
		...
		$scope.queryFC = function(){
			...
			$scope.sendRecv("PMS106", "queryFCD", "com.systex.jbranch.app.server.fps.pms106.PMS106InputVO", $scope.inputVO,
