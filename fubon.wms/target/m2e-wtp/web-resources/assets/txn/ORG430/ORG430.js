 ...
 */
'use strict';
eSoafApp.controller('ORG430Controller', function(sysInfoService, $scope, $controller, $filter, socketService, ngDialog, projInfoService) {
	$controller('BaseController', {$scope : $scope});
	$scope.controllerName = "ORG430Controller";
	...
	$scope.query = function() {
		$scope.totals = {};
		$scope.sendRecv("ORG430", "query", "com.systex.jbranch.app.server.fps.org430.ORG430InputVO", $scope.inputVO, function(tota, isError) {
			if (isError) {
	...
	$scope.export = function() {
		...
		$scope.sendRecv("ORG430", "export", "com.systex.jbranch.app.server.fps.org430.ORG430InputVO", $scope.inputVO,
