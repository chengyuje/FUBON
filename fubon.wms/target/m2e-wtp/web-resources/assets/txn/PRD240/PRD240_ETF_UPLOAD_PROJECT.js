 ...
 */
'use strict';
eSoafApp.controller('PRD240_ETF_UPLOAD_PROJECTController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD240_ETF_UPLOAD_PROJECTController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD240", "uploadProject", "com.systex.jbranch.app.server.fps.prd240.PRD240InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
