 ...
 */
'use strict';
eSoafApp.controller('PMS009Controller', function($rootScope, $scope,
	...
	$scope.controllerName = "PMS009Controller";
	...
	$scope.init = function() {
		...
		$scope.inputVO.sTime=  $scope.connector('get','PMS329_M1');//時間
		$scope.inputVO.eTime=  $scope.connector('get','PMS329_M2');//時間
		$scope.paramList = $scope.connector('get','PMS329_L');
...
//		}
	...
	$scope.returnback = function() {
		...
		var paths=[];
//		$scope.connector('set','XPMS329_M1', $scope.inputVO.sTime ); //時間
//		$scope.connector('set','XPMS329_M2', $scope.inputVO.eTime ); //時間
//		$scope.connector('set','XPMS329_R', $scope.inputVO.region_center_id ); //業務處
//		$scope.connector('set','XPMS329_BA', $scope.inputVO.branch_area_id ); //營運區
//		$scope.connector('set','XPMS329_BN', $scope.inputVO.branch_nbr ); //分行別
//		$scope.connector('set','XPMS329_A', $scope.inputVO.ao_code ); //理專
//		$scope.connector('set','XPMS329_L', $scope.REGION_LIST ); //REGION_LIST
	...
	$scope.returnback1 = function() {
		...
		$rootScope.menuItemInfo.url = "assets/txn/PMS329/PMS329.html";
