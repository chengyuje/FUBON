 ...
 */
'use strict';
eSoafApp.controller('PMS222Controller',
	function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService) 
	{
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS222Controller";	
		//繼承共用的組繼連動選單
		...
		$scope.rptVersionChange = function() {
			...
			$scope.sendRecv("PMS222", "version", "com.systex.jbranch.app.server.fps.pms222.PMS222InputVO", $scope.inputVO,
      ...
      //選取月份下拉選單 --> 重新設定可視範圍
        ...
        $scope.exportRPT = function(){
			$scope.sendRecv("PMS222", "export",	"com.systex.jbranch.app.server.fps.pms222.PMS222OutputVO",{
		...
		$scope.inquire = function()
		{
			...
			$scope.sendRecv("PMS222", "inquire", "com.systex.jbranch.app.server.fps.pms222.PMS222InputVO", $scope.inputVO,
