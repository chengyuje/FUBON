 ...
 */
'use strict';
eSoafApp.controller('CAM210_5_branch_Controller',
	function($scope, $controller, socketService, projInfoService, $q, $filter) {
		...
		$scope.inquire = function(){
			$scope.sendRecv("CAM210", "expiredActivities_branchList", "com.systex.jbranch.app.server.fps.cam210.CAM210InputVO", $scope.inputVO,
