 ...
 */
'use strict';
eSoafApp.controller('CAM210_4_branch_Controller',
	function($scope, $controller, socketService, projInfoService, $q, $filter) {
		...
		$scope.inquire = function(){
			$scope.sendRecv("CAM210", "sightActivities_branchList", "com.systex.jbranch.app.server.fps.cam210.CAM210InputVO", $scope.inputVO,
	        		function(tota, isError) {
	        			if (!isError) {
	        				console.log("tota[0].body.resultList.length = " + tota[0].body.resultList.length);
