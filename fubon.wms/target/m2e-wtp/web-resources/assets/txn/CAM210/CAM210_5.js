 ...
 */
'use strict';
eSoafApp.controller('CAM210_5_Controller',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		...
		$scope.inquire = function(){
			$scope.sendRecv("CAM210", "expiredActivities_opArea", "com.systex.jbranch.app.server.fps.cam210.CAM210InputVO", $scope.inputVO,
