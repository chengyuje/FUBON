 ...
 */
'use strict';
eSoafApp.controller('CAM210_4_ao_Controller',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		...
		$scope.inquire = function(){
			$scope.sendRecv("CAM210", "sightActivities_aoList", "com.systex.jbranch.app.server.fps.cam210.CAM210InputVO", $scope.inputVO,
