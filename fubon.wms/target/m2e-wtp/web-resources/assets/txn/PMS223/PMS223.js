 ...
 */
'use strict';
eSoafApp.controller('PMS223Controller',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PMS223Controller";
      ...
      //理專資訊
		...
		$scope.query = function(){
			...
			$scope.sendRecv("PMS223", "queryData", "com.systex.jbranch.app.server.fps.pms223.PMS223InputVO", $scope.inputVO,
		...
		$scope.exportRPT = function(){
			$scope.sendRecv("PMS223", "export", "com.systex.jbranch.app.server.fps.pms223.PMS223OutputVO", $scope.outputVO,
					function(tota, isError) {						
						if (isError) {
