'use strict';
eSoafApp.controller('FPS910_DETAIL_STOCKController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter, getParameter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "FPS910_DETAIL_STOCKController";
...
//            	$scope.showSuccessMsg('刪除成功');
		...
		$scope.$on('getResultList', function(){
			$scope.connector('set', 'stockList', $scope.inputVO.stockList);
		});
});