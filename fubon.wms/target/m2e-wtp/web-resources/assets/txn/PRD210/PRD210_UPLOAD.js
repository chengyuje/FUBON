 ...
 */
'use strict';
eSoafApp.controller('PRD210_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD210_UPLOADController";
		
		$scope.inputVO = {};
		
		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD210", "downloadSimple", "com.systex.jbranch.app.server.fps.prd210.PRD210InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD210", "upload", "com.systex.jbranch.app.server.fps.prd210.PRD210InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
