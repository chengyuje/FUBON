 ...
 */
'use strict';
eSoafApp.controller('PRD230_Fund_UPLOADWARNINGController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD230_Fund_UPLOADWARNINGController";
		
		$scope.inputVO = {};
		
		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD230", "downloadWarningSimple", "com.systex.jbranch.app.server.fps.prd230.PRD230InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD230", "uploadWarning", "com.systex.jbranch.app.server.fps.prd230.PRD230InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
