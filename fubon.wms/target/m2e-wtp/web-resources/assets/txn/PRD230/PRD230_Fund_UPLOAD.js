 ...
 */
'use strict';
eSoafApp.controller('PRD230_Fund_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD230_Fund_UPLOADController";
		
		$scope.inputVO = {};
		
		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD230", "downloadSimple", "com.systex.jbranch.app.server.fps.prd230.PRD230InputVO", {},
        ...
        $scope.save = function() {
			console.log("save");
        	$scope.sendRecv("PRD230", "upload", "com.systex.jbranch.app.server.fps.prd230.PRD230InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
