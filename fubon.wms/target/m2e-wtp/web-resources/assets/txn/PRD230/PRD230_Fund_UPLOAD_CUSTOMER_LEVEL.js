 ...
 */
'use strict';
eSoafApp.controller('PRD230_Fund_UPLOAD_CUSTOMER_LEVELController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD230_Fund_UPLOAD_CUSTOMER_LEVELController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD230", "uploadCustomerLevel", "com.systex.jbranch.app.server.fps.prd230.PRD230InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
