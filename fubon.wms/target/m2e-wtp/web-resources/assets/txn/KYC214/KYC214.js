...
//        	$scope.edit=[{LABEL:'修改',DATA:'U'},{LABEL:'刪除',DATA:'D'}];
        ...
        $scope.queryData = function(){
        	$scope.sendRecv("KYC214","queryData","com.systex.jbranch.app.server.fps.kyc214.KYC214InputVO",
