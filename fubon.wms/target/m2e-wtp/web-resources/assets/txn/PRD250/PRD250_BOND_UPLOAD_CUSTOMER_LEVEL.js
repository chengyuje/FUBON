 ...
 */
'use strict';
eSoafApp.controller('PRD250_BOND_UPLOAD_CUSTOMER_LEVELController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD250_BOND_UPLOAD_CUSTOMER_LEVELController";
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD250", "uploadCustomerLevel", "com.systex.jbranch.app.server.fps.prd250.PRD250InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
