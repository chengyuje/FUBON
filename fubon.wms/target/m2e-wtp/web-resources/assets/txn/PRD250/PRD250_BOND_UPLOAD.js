 ...
 */
'use strict';
eSoafApp.controller('PRD250_BOND_UPLOADController',
	function($scope, $controller, socketService, ngDialog, projInfoService, $q, $confirm, $filter) {
		$controller('BaseController', {$scope: $scope});
		$scope.controllerName = "PRD250_BOND_UPLOADController";

		$scope.inputVO = {};

		$scope.downloadSimple = function() {
        	$scope.sendRecv("PRD250", "downloadSimple", "com.systex.jbranch.app.server.fps.prd250.PRD250InputVO", {},
        ...
        $scope.save = function() {
        	$scope.sendRecv("PRD250", "upload", "com.systex.jbranch.app.server.fps.prd250.PRD250InputVO", $scope.inputVO,
					function(tota, isError) {
		        		if (isError) {
