...
'use strict';
eSoafApp.controller('MAO141_addController', function($rootScope, $scope, $controller, $confirm, socketService, ngDialog, projInfoService, $filter, getParameter) {
	...
	$scope.add = function(){
    	$scope.sendRecv("MAO141", "add", "com.systex.jbranch.app.server.fps.mao141.MAO141InputVO", $scope.inputVO, function(totas, isError) {
			if (isError) {
