					...
					function(tota, isError) {
						if (!isError) {
							...
							if(tota[0].body.currRateData != null ) {
								...
								$scope.curCRateData.PERCENTAGE_1 = rData.PERCENTAGE_1.toString() + "%";
								$scope.curCRateData.PERCENTAGE_2 = rData.PERCENTAGE_2.toString() + "%";
								$scope.curCRateData.PERCENTAGE_3 = rData.PERCENTAGE_3.toString() + "%";
								$scope.curCRateData.PERCENTAGE_4 = rData.PERCENTAGE_4.toString() + "%";
								$scope.curCRateData.remark1 = "上限" + rData.BASE_PERC_1.toString() + "%，" + ((rData.PERCENTAGE_1 > rData.BASE_PERC_1) ? "已超限" : "未超限");
								$scope.curCRateData.remark2 = "上限" + rData.BASE_PERC_2.toString() + "%，" + ((rData.PERCENTAGE_2 > rData.BASE_PERC_2) ? "已超限" : "未超限");
								$scope.curCRateData.remark3 = "上限" + rData.BASE_PERC_3.toString() + "%，" + ((rData.PERCENTAGE_3 > rData.BASE_PERC_3) ? "已超限" : "未超限");
								$scope.curCRateData.remark4 = "上限" + rData.BASE_PERC_4.toString() + "%，" + ((rData.PERCENTAGE_4 > rData.BASE_PERC_4) ? "已超限" : "未超限");
        		...
        		function(tota, isError) {
					if (!isError) {
						...
						if(tota[0].body.currRateData != null ) {
							...
							$scope.trialCalData.remark2 = "上限" + rData.BASE_PERC_2.toString() + "%，" + ((rData.PERCENTAGE_2 > rData.BASE_PERC_2) ? "已超限" : "未超限");
							$scope.trialCalData.remark3 = "上限" + rData.BASE_PERC_3.toString() + "%，" + ((rData.PERCENTAGE_3 > rData.BASE_PERC_3) ? "已超限" : "未超限");
							$scope.trialCalData.remark4 = "上限" + rData.BASE_PERC_4.toString() + "%，" + ((rData.PERCENTAGE_4 > rData.BASE_PERC_4) ? "已超限" : "未超限");
