...
public class TBPRD_INS_AGEPK  implements Serializable  {
    ...
    /** full constructor */
    public TBPRD_INS_AGEPK(BigDecimal INSPRD_ANNUAL, String INSURED_OBJECT, String PAY_TYPE, String PRD_ID) {
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBPRD_INS_AGEPK) ) return false;
        TBPRD_INS_AGEPK castOther = (TBPRD_INS_AGEPK) other;
