...
public class TBKYC_INVESTOREXAM_MVO extends VOBase {
    ...
    /** default constructor */
    public TBKYC_INVESTOREXAM_MVO() {
    }

    /** minimal constructor */
    public TBKYC_INVESTOREXAM_MVO(String SEQ, String EXAM_VERSION, String CUST_ID, String CUST_RISK_AFR, Timestamp EXPIRY_DATE) {
        this.SEQ = SEQ;
        this.EXAM_VERSION = EXAM_VERSION;
        this.CUST_ID = CUST_ID;
        this.CUST_RISK_AFR = CUST_RISK_AFR;
