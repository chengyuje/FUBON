...
public class TBCAM_SFA_CAMP_DOC_MAPPPK  implements Serializable  {
    ...
    /** full constructor */
    public TBCAM_SFA_CAMP_DOC_MAPPPK(String CAMPAIGN_ID, String SFA_DOC_ID, String STEP_ID) {
    ...
    /** default constructor */
    public TBCAM_SFA_CAMP_DOC_MAPPPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBCAM_SFA_CAMP_DOC_MAPPPK) ) return false;
        TBCAM_SFA_CAMP_DOC_MAPPPK castOther = (TBCAM_SFA_CAMP_DOC_MAPPPK) other;
