...
public class TBPRD_FUNDINFOVO extends VOBase {
    ...
    /** nullable persistent field */
    private String CDSC_MONTH;
    
    /** nullable persistent field */
    private String STOCK_BOND_TYPE;

public static final String TABLE_UID = "com.systex.jbranch.app.common.fps.table.TBPRD_FUNDINFO";
...
public String getTableuid () {
    ...
    /** full constructor */
    public TBPRD_FUNDINFOVO(String PRD_ID, String LIPPER_ID, BigDecimal ALLOTMENT_RATIO, String MAIN_PRD, Timestamp MAIN_PRD_SDATE, Timestamp MAIN_PRD_EDATE, String RAISE_FUND, Timestamp RAISE_FUND_SDATE, Timestamp RAISE_FUND_EDATE, String IPO, Timestamp IPO_SDATE, Timestamp IPO_EDATE, BigDecimal CNR_YIELD, BigDecimal CNR_MULTIPLE, BigDecimal CNR_FEE, String FUS20, String FUS40, String NO_E_PURCHASE, String NO_E_OUT, String NO_E_IN, String NO_E_BUYBACK, String QUOTA_CONTROL, BigDecimal Y_RETURN, BigDecimal Y_STD, Timestamp SDATE, Timestamp EDATE, BigDecimal LIPPER_RANK, BigDecimal LIPPER_BENCHMARK_ID, Timestamp MULTIPLE_SDATE, Timestamp MULTIPLE_EDATE, BigDecimal CNR_DISCOUNT, BigDecimal RATE_DISCOUNT, String IS_CNR_TARGET, Timestamp CNR_TARGET_SDATE, Timestamp CNR_TARGET_EDATE, String ACT_TYPE, String REVIEW_STATUS, Timestamp createtime, String creator, String modifier, Timestamp lastupdate, String SELLING, Long version, String VIGILANT, String CDSC_MONTH, String STOCK_BOND_TYPE) {
        this.PRD_ID = PRD_ID;
        ...
        this.CDSC_MONTH = CDSC_MONTH;
        this.STOCK_BOND_TYPE = STOCK_BOND_TYPE;
    }

    /** default constructor */
    public TBPRD_FUNDINFOVO() {
    }

    /** minimal constructor */
    public TBPRD_FUNDINFOVO(String PRD_ID) {
        this.PRD_ID = PRD_ID;
    }
	...
	public String getCDSC_MONTH() {
		return this.CDSC_MONTH;
	}

	public void setCDSC_MONTH(String CDSC_MONTH) {
		this.CDSC_MONTH = CDSC_MONTH;
	}
