...
public class TBSOT_SI_TRADE_DPK  implements Serializable  {
    ...
    /** full constructor */
    public TBSOT_SI_TRADE_DPK(BigDecimal SEQ_NO, String TRADE_SEQ) {
        this.SEQ_NO = SEQ_NO;
        this.TRADE_SEQ = TRADE_SEQ;
    }

    /** default constructor */
    public TBSOT_SI_TRADE_DPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBSOT_SI_TRADE_DPK) ) return false;
        TBSOT_SI_TRADE_DPK castOther = (TBSOT_SI_TRADE_DPK) other;
