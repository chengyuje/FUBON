...
public class TBSQM_CSM_IMPROVE_MASTPK  implements Serializable  {
    ...
    /** full constructor */
    public TBSQM_CSM_IMPROVE_MASTPK(String CUST_ID, String DATA_DATE, String QTN_TYPE, BigDecimal SEQ) {
    ...
    /** default constructor */
    public TBSQM_CSM_IMPROVE_MASTPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBSQM_CSM_IMPROVE_MASTPK) ) return false;
        TBSQM_CSM_IMPROVE_MASTPK castOther = (TBSQM_CSM_IMPROVE_MASTPK) other;
