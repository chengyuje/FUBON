...
public class TBSOT_NF_PURCHASE_DPK  implements Serializable  {
    ...
    /** full constructor */
    public TBSOT_NF_PURCHASE_DPK(BigDecimal SEQ_NO, String TRADE_SEQ) {
        this.SEQ_NO = SEQ_NO;
        this.TRADE_SEQ = TRADE_SEQ;
    }

    /** default constructor */
    public TBSOT_NF_PURCHASE_DPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBSOT_NF_PURCHASE_DPK) ) return false;
        TBSOT_NF_PURCHASE_DPK castOther = (TBSOT_NF_PURCHASE_DPK) other;
