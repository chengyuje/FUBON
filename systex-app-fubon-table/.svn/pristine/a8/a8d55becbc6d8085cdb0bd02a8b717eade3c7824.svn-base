...
public class TBPMS_AO_PRD_TAR_MVO extends VOBase {

    /** identifier field */
    private com.systex.jbranch.app.common.fps.table.TBPMS_AO_PRD_TAR_MPK comp_id;
...
public static final String TABLE_UID = "com.systex.jbranch.app.common.fps.table.TBPMS_AO_PRD_TAR_M";
...
public String getTableuid () {
    ...
    /** full constructor */
    public TBPMS_AO_PRD_TAR_MVO(com.systex.jbranch.app.common.fps.table.TBPMS_AO_PRD_TAR_MPK comp_id, String REGION_CENTER_NAME, String BRANCH_AREA_NAME, String BRANCH_NAME, String AO_CODE, String EMP_NAME, String JOB_TITLE_ID, Timestamp FIRST_DATE, String JOB_TITLE, BigDecimal TAR_AMOUNT, Timestamp MAINTAIN_DATE, String MAINTAIN_NAME, Timestamp createtime, String creator, String modifier, Timestamp lastupdate, Long version) {
    ...
    /** default constructor */
    public TBPMS_AO_PRD_TAR_MVO() {
    }

    /** minimal constructor */
    public TBPMS_AO_PRD_TAR_MVO(com.systex.jbranch.app.common.fps.table.TBPMS_AO_PRD_TAR_MPK comp_id) {
        this.comp_id = comp_id;
    }

    public com.systex.jbranch.app.common.fps.table.TBPMS_AO_PRD_TAR_MPK getcomp_id() {
        return this.comp_id;
    }

    public void setcomp_id(com.systex.jbranch.app.common.fps.table.TBPMS_AO_PRD_TAR_MPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBPMS_AO_PRD_TAR_MVO) ) return false;
        TBPMS_AO_PRD_TAR_MVO castOther = (TBPMS_AO_PRD_TAR_MVO) other;
