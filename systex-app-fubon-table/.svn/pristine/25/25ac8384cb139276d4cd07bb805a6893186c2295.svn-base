...
public class TBFPS_OTHER_PARA_HEADVO extends VOBase {
...
public static final String TABLE_UID = "com.systex.jbranch.app.common.fps.table.TBFPS_OTHER_PARA_HEAD";
...
public String getTableuid () {
    ...
    /** full constructor */
    public TBFPS_OTHER_PARA_HEADVO(String PARAM_NO, Timestamp EFFECT_START_DATE, Timestamp EFFECT_END_DATE, Timestamp SUBMIT_DATE, String STATUS, Timestamp createtime, String creator, String modifier, Timestamp lastupdate, Long version) {
    ...
    /** default constructor */
    public TBFPS_OTHER_PARA_HEADVO() {
    }

    /** minimal constructor */
    public TBFPS_OTHER_PARA_HEADVO(String PARAM_NO, Timestamp EFFECT_START_DATE, String STATUS) {
        this.PARAM_NO = PARAM_NO;
        this.EFFECT_START_DATE = EFFECT_START_DATE;
        this.STATUS = STATUS;
    }
