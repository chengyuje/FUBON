...
public class TBPMS_PS_PRD_TAR_MPK  implements Serializable  {
    ...
    /** full constructor */
    public TBPMS_PS_PRD_TAR_MPK(String BRANCH_AREA_ID, String BRANCH_NBR, String DATA_YEARMON, String EMP_ID, String REGION_CENTER_ID) {
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBPMS_PS_PRD_TAR_MPK) ) return false;
        TBPMS_PS_PRD_TAR_MPK castOther = (TBPMS_PS_PRD_TAR_MPK) other;
