...
public class TBPMS_EMPLOYEE_RECPK  implements Serializable  {
    ...
    /** full constructor */
    public TBPMS_EMPLOYEE_RECPK(String AO_CODE, String EMP_ID, String ORG_ID, Timestamp START_TIME) {
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBPMS_EMPLOYEE_RECPK) ) return false;
        TBPMS_EMPLOYEE_RECPK castOther = (TBPMS_EMPLOYEE_RECPK) other;
