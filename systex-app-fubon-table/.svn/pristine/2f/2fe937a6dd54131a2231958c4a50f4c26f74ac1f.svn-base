...
public class TBSQM_CSM_IMPROVE_MASTVO extends VOBase {
    ...
    /** identifier field */
    private com.systex.jbranch.app.common.fps.table.TBSQM_CSM_IMPROVE_MASTPK comp_id;
...
public String getTableuid () {
    ...
    public com.systex.jbranch.app.common.fps.table.TBSQM_CSM_IMPROVE_MASTPK getcomp_id() {
        return this.comp_id;
    }

    public void setcomp_id(com.systex.jbranch.app.common.fps.table.TBSQM_CSM_IMPROVE_MASTPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBSQM_CSM_IMPROVE_MASTVO) ) return false;
