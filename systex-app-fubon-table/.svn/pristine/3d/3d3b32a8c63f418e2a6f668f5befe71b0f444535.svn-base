...
public class TBPRD_INSINFOVO extends VOBase {
...
public static final String TABLE_UID = "com.systex.jbranch.app.common.fps.table.TBPRD_INSINFO";
...
public String getTableuid () {
    ...
    /** default constructor */
    public TBPRD_INSINFOVO() {
    }

    /** minimal constructor */
    public TBPRD_INSINFOVO(String PRD_ID) {
        this.PRD_ID = PRD_ID;
    }
