...
public class TBORG_ROLE_REVIEWVO extends VOBase {
...
public static final String TABLE_UID = "com.systex.jbranch.app.common.fps.table.TBORG_ROLE_REVIEW";
...
public String getTableuid () {
    ...
    /** full constructor */
    public TBORG_ROLE_REVIEWVO(BigDecimal SEQNO, String ROLE_ID, String ROLE_NAME, String JOB_TITLE_NAME, String IS_AO, String AGENT_ROLE, String SYS_ROLE, String ACT_TYPE, String REVIEW_STATUS, Timestamp createtime, String creator, String modifier, Timestamp lastupdate, Long version) {
        this.SEQNO = SEQNO;
    ...
    /** default constructor */
    public TBORG_ROLE_REVIEWVO() {
    }

    /** minimal constructor */
    public TBORG_ROLE_REVIEWVO(BigDecimal SEQNO) {
        this.SEQNO = SEQNO;
    }
