...
public class TBPMS_BNKALT_RPTPK  implements Serializable  {
    ...
    /** full constructor */
    public TBPMS_BNKALT_RPTPK(Timestamp ACCESS_TIME, String BRANCH_NBR, String DEVICE_ID, String EMP_ID) {
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBPMS_BNKALT_RPTPK) ) return false;
        TBPMS_BNKALT_RPTPK castOther = (TBPMS_BNKALT_RPTPK) other;
