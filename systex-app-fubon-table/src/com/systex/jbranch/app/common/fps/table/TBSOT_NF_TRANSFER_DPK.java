...
public class TBSOT_NF_TRANSFER_DPK  implements Serializable  {
    ...
    /** full constructor */
    public TBSOT_NF_TRANSFER_DPK(BigDecimal SEQ_NO, String TRADE_SEQ) {
        this.SEQ_NO = SEQ_NO;
        this.TRADE_SEQ = TRADE_SEQ;
    }

    /** default constructor */
    public TBSOT_NF_TRANSFER_DPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBSOT_NF_TRANSFER_DPK) ) return false;
        TBSOT_NF_TRANSFER_DPK castOther = (TBSOT_NF_TRANSFER_DPK) other;
