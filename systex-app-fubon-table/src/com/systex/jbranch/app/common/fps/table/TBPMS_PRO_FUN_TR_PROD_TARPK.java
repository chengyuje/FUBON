...
public class TBPMS_PRO_FUN_TR_PROD_TARPK  implements Serializable  {
    ...
    /** full constructor */
    public TBPMS_PRO_FUN_TR_PROD_TARPK(String BRANCH_NBR, String DATA_YEARMON, String EMP_ID, String OP_AREA_ID, String REGION_CENTER_ID) {
    ...
    /** default constructor */
    public TBPMS_PRO_FUN_TR_PROD_TARPK() {
    }
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("OP_AREA_ID", getOP_AREA_ID())
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBPMS_PRO_FUN_TR_PROD_TARPK) ) return false;
        TBPMS_PRO_FUN_TR_PROD_TARPK castOther = (TBPMS_PRO_FUN_TR_PROD_TARPK) other;
        return new EqualsBuilder()
            ...
            .append(this.getOP_AREA_ID(), castOther.getOP_AREA_ID())
