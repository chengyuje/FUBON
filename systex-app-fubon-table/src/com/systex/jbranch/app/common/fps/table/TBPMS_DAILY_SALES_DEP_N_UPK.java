...
public class TBPMS_DAILY_SALES_DEP_N_UPK  implements Serializable  {
    ...
    /** full constructor */
    public TBPMS_DAILY_SALES_DEP_N_UPK(String BRANCH_NBR, String ID, Timestamp TRADE_DATE) {
    ...
    /** default constructor */
    public TBPMS_DAILY_SALES_DEP_N_UPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBPMS_DAILY_SALES_DEP_N_UPK) ) return false;
        TBPMS_DAILY_SALES_DEP_N_UPK castOther = (TBPMS_DAILY_SALES_DEP_N_UPK) other;
