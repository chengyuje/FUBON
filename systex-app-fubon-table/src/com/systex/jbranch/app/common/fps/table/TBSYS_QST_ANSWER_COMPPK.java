...
public class TBSYS_QST_ANSWER_COMPPK  implements Serializable  {
    ...
    /** full constructor */
    public TBSYS_QST_ANSWER_COMPPK(BigDecimal ANSWER_SEQ, String QUESTION_VERSION) {
        this.ANSWER_SEQ = ANSWER_SEQ;
        this.QUESTION_VERSION = QUESTION_VERSION;
    }

    /** default constructor */
    public TBSYS_QST_ANSWER_COMPPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBSYS_QST_ANSWER_COMPPK) ) return false;
        TBSYS_QST_ANSWER_COMPPK castOther = (TBSYS_QST_ANSWER_COMPPK) other;
