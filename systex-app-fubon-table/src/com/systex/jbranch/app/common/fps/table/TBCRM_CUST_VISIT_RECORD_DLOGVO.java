...
public class TBCRM_CUST_VISIT_RECORD_DLOGVO extends VOBase {
	...
	public static final String TABLE_UID = "com.systex.jbranch.app.common.fps.table.TBCRM_CUST_VISIT_RECORD_DLOG";
	...
	/** full constructor */
	public TBCRM_CUST_VISIT_RECORD_DLOGVO(String VISIT_SEQ, String VISITOR_ROLE, String CUST_ID, String CMU_TYPE, String VISIT_MEMO, Timestamp VISIT_DT, String VISIT_CREPLY,String creator, Timestamp createtime, String modifier, Timestamp lastupdate, Long version) {
	...
	/** default constructor */
	public TBCRM_CUST_VISIT_RECORD_DLOGVO() {
	}
	...
	/** minimal constructor */
	public TBCRM_CUST_VISIT_RECORD_DLOGVO(String VISIT_SEQ) {
		this.VISIT_SEQ = VISIT_SEQ;
	}
