...
public class TBSOT_NF_TRANSFER_DYNAPK  implements Serializable  {
    ...
    /** full constructor */
    public TBSOT_NF_TRANSFER_DYNAPK(BigDecimal SEQ_NO, String TRADE_SEQ) {
        this.SEQ_NO = SEQ_NO;
        this.TRADE_SEQ = TRADE_SEQ;
    }

    /** default constructor */
    public TBSOT_NF_TRANSFER_DYNAPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof TBSOT_NF_TRANSFER_DYNAPK) ) return false;
        TBSOT_NF_TRANSFER_DYNAPK castOther = (TBSOT_NF_TRANSFER_DYNAPK) other;
